...
This module generates a horoscope based on the user's birthday, birth time, and location of birth.
"""
...
def get_horoscope(birthday: str, birth_time: str, location: str) -> str:
    """
    Generate a horoscope based on the user's birthday, birth time, and location of birth.
    ...
    #We set a seed here so we can reproduce the same horoscope using a combination of birth date and time
